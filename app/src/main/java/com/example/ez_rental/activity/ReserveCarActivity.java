...
import com.example.ez_rental.ActivityPages.BookingSummaryActivity;
...
public class ReserveCarActivity extends AppCompatActivity implements GetCarDriverDialog.GetCarDriverListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SECOND_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                /*cd = (Car_Driver)data.getSerializableExtra("Car_Driver");*/
    ...
    private void listenHandler() {
        ...
        continueBooking2.setOnClickListener(v -> {
            validate();
            int days = Math.toIntExact(daysDIff);
            Intent informationPage = new Intent(ReserveCarActivity.this, BookingSummaryActivity.class);
