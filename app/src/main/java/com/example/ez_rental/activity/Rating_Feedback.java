...
public class Rating_Feedback {
    ...
    String HttpURL = "http://192.168.1.3/android_login_api/makeFeedbck.php";

    String HttpUpdate = "http://192.168.1.3/android_login_api/UpdateReserve.php";
    ...
    public void InsertFeedback( final String Feedback_ID,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, HttpURL , response -> {
