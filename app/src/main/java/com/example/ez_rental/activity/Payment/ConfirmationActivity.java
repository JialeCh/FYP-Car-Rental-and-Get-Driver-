...
public class ConfirmationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Payment_Amount = intent.getStringExtra("PaymentAmount");
        Log.d(TAG,"Car ID" + Payment_Amount);
    ...
    private void showDetails(JSONObject jsonDetails, String paymentAmount) throws JSONException {
        ...
        Log.d(TAG,"Payment_Amount" + Payment_Amount);
    ...
    public void ReservationUpdate(final int Reserve_ID, final int Car_Id, final String phone_no) {
        class ReservationUpdateClass extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                finalResult = httpParse.postRequest(hashMap, AppConfig.URL_UpReserve);
