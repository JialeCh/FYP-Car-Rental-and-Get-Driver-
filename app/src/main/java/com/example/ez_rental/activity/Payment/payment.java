    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPay.setOnClickListener(v -> {
            if (method.contains("Cash")){
                ...
                ReservationUpdate(Reservation_ID,Car_id,phone_no);
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        Log.d(TAG,"Car IDxxx" + paymentAmount);
    ...
    public void ReservationUpdate(final int Reserve_ID, final int Car_Id, final String phone_no) {
        class ReservationUpdateClass extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                finalResult = httpParse.postRequest(hashMap, AppConfig.URL_UpReserveCash);
