    ...
    private void listenHandler() {
        ...
        book.setOnClickListener(v -> {
           ...
           if(check == true){
            ...
            Intent reservationCompletePage = new Intent(BookingSummaryActivity.this,BookingCompleteActivity.class);
        ...
        payNow.setOnClickListener(v -> {
            ...
            new Handler().postDelayed(() -> {
                ...
                Intent payment = new Intent(BookingSummaryActivity.this, payment.class);
